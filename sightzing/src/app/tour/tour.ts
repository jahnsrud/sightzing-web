...
export class Tour {
    ...
    fillListWithTours(){
        ...
        this.addNewTourToList("Hidden Treasures of Oslo", "Avoid the tourist traps and experience Oslo like the people who live there.", "../assets/imgs/all-attractions.jpg", 5, attraction.getAttractionByCategory("Nature & Parks"))
