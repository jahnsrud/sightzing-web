  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public tourList: TourList, public modalController: ModalController) {
    ...
    this.items = [
        ...
        iconName: "add"},
      {
        ...
        content: "sihgtZing's mission is to help travelers exploring Oslo for the first time, give them the basic knowledge of how to get to one point from another. We want to help people and give them the ultimate experience when they first come to Oslo. Creators, Markus Jahnsrud, Stine Sandberg, Håvard Nordlie Mathisen, Marcus Tveide Jensen, Andreas Breime Persson",
        expanded: false,
        iconName: "add"},
      {
        title: 'Terms and Conditions',
        content: 'Please read these Terms and Conditions carefully before using the sightZing mobile application operated by us. Your access to and use of the Service is conditioned on your acceptance of and compilance with these terms. these terms apply to all visitors, users and others who access or use the service. By accessing or using the service you agree to be bound by these Terms. If you disagree with any part of the terms then you may not access the Service.',
        expanded: false,
        iconName: "add"}
        ];
